...
lint:
	go run github.com/golangci/golangci-lint/cmd/golangci-lint@v1.64 run --config .golangci.yml --timeout=5m --out-format colored-line-number

lint-fix:
	go run github.com/golangci/golangci-lint/cmd/golangci-lint@v1.64 run --fix --config .golangci.yml --timeout=5m --out-format colored-line-number
